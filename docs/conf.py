...
# -*- coding: utf-8 -*-
#
# rpm-versiontracker documentation build configuration file
#
...
latex_documents = [
  (master_doc, 'weirdo.tex', 'WeIRDO Documentation',
...
man_pages = [
    (master_doc, 'weirdo', 'WeIRDO Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'weirdo', 'WeIRDO Documentation',
   author, 'weirdo', 'One line description of project.',
   'Miscellaneous'),
]
